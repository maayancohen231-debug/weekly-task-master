...
import { Plus, Target, Trash2, CheckSquare, Square } from 'lucide-react';
  ...
  return (
    <div className="shrink-0 bg-card rounded-2xl shadow-card overflow-hidden">
      <div className="flex items-center gap-2 px-3 pt-3 pb-2">
        ...
        <button
          onClick={openEditor}
          className="ml-auto p-1 text-muted-foreground/40 hover:text-primary rounded-lg transition-base"
